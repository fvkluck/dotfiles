...
local function lsp_connection()
  ...
  elseif (message.status == "end") then
    return "\239\131\136"
  elseif ((message.status == "") and not vim.tbl_isempty(vim.lsp.get_clients({buffer = 0}))) then
    return "\239\131\136"
  else
    return "\239\130\150"
  end
