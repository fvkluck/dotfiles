...
do
  local options = {expandtab = true, list = true, listchars = "tab:>-,trail:.,extends:>", clipboard = "unnamedplus", tabstop = 2, shiftwidth = 2, softtabstop = 2, completeopt = "menuone,noselect", undofile = true, undodir = "/Users/florian/.vim/undo", undolevels = 1000, undoreload = 10000, number = true, relativenumber = true, ruler = true, signcolumn = "number", grepprg = "ag --vimgrep --nogroup --nocolor -s --ignore tags", termguicolors = true}
